...
//		}
	...
	IEnumerator axesTests() {
        ...
        WMG_Anim.animVec3(() => graph.originV3, x => graph.originV3 = x, animDuration, new Vector3(graph.theOrigin.x, graph.yAxis.AxisMaxValue), Ease.Linear);
        ...
        WMG_Anim.animVec3(() => graph.originV3, x => graph.originV3 = x, animDuration, new Vector2(graph.xAxis.AxisMaxValue, graph.theOrigin.y), Ease.Linear);
        ...
        WMG_Anim.animVec3(() => graph.originV3, x => graph.originV3 = x, animDuration, new Vector2(0, 0), Ease.Linear);
