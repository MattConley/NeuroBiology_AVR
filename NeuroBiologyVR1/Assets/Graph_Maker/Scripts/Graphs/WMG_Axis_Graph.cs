...
public class WMG_Axis_Graph : WMG_Graph_Manager
{
    ...
    public Vector3 originV3
    {
        ...
        set
        {
            Vector2 tempVec = new Vector3(value.x, value.y);
            if (_theOrigin != tempVec)
            {
                _theOrigin = tempVec;
                graphC.Changed();
                seriesNoCountC.Changed();
    ...
    [WMG_EnumFlagAttribute]
    [SerializeField]
    private AutoPaddingProperties _autoPaddingProperties;
    [SerializeField]
    private bool _autoPaddingEnabled;
    [SerializeField]
    private float _autoPaddingAmount;
    [SerializeField]
    ...
    [SerializeField]
    private int _graphTitleSize = 18;
    ...
    void getAutoPaddingDifferentialFromGraphContent(ref Vector2 xDif, ref Vector2 yDif)
    {
        ...
        if (axesType == axesTypes.DUAL_Y && !yAxis2.hideTicks)
        { // y2 ticks
